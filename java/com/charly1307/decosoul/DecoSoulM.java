...
import com.charly1307.decosoul.common.entity.monster.render.HollowKnightRender;
...
public class DecoSoulM {
	...
	private void doClientStuff(final FMLClientSetupEvent event) {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityTypesModR.HOLLOW_KNIGHT.get(), HollowKnightRender::new);
