...
public class EntityTypesModR {
	...
	public static final RegistryObject<EntityType<HollowKnightEntity>> HOLLOW_KNIGHT = ENTITY_TYPES.register(
			"hollow_knight", () -> EntityType.Builder.create(HollowKnightEntity::new, EntityClassification.MONSTER)
					.size(1f, 2f).build(new ResourceLocation(DecoSoulM.MOD_ID, "hollow_knight").toString()));
