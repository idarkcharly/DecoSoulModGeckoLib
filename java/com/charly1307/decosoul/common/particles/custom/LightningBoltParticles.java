...
public class LightningBoltParticles extends SpriteTexturedParticle {

	protected LightningBoltParticles(ClientWorld world, double x, double y, double z, IAnimatedSprite sprite,
