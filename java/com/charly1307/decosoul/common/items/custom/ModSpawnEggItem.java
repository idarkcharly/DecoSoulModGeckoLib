...
public class ModSpawnEggItem extends SpawnEggItem {
	...
	@Deprecated
	public ModSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, int primaryColorIn,
			int secondaryColorIn, Properties builder) {
		super(null, secondaryColorIn, secondaryColorIn, builder);
